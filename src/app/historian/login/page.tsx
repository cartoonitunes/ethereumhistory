      ...
      <div className="max-w-md mx-auto px-4 py-16">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-obsidian-950 px-3 text-obsidian-500">or</span>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center gap-2 text-sm text-obsidian-400 hover:text-obsidian-200 transition-colors mb-4"
        >
          {tokenLoginOpen ? (
